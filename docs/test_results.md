...
## Batch-32 controlled ablation（L1 與 augmentation）— 完成

四條件均使用 MacBERT、batch 32、lr 2e-5、4 epochs、max_len 256、相同 checkpoint criterion，
並跑 seeds 42/1/2。
...
**結論：**L1 與 No L1 的四項 test 指標接近。加入 E/F2 後，A-PCC 分別由 0.370
變為 0.373/0.387，而 A-MAE 由 0.923 變為 1.057/1.073；F2 呈現最大的
arousal ranking–calibration trade-off。
